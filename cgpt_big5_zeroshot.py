...
Q66. 優れた賞を持っており，優れた賞を活かせる"""
    ...
    for p in products:
        if (p[0] == "高い" and p[1] == "高い" and p[2] == "低い" and p[3] == "高い" and p[4] == "低い"):
    ...
    開放性:{openness}
            ...
            for i in range(0, len(text_list), n):
                ...
                ans += tmp_ans + "\n"
            print(ans)
            print(ans, file=codecs.open(f'zeroshot_answers/o_{p[0]}_c_{p[1]}_e_{p[2]}_a_{p[3]}_n_{p[4]}_zeroshot.txt', 'w', 'utf-8'))
